...
const Quiz = () => {
    ...
    const {characters, setCharactersFromService, getCharacterById} = useContext(CharacterContext) as ICharacterContext; 
    const [message, setMessage] = useState<string | null>(null);
    let [numberClicked, setNumberClicked] = useState<number>(0);
    let [correctAnswerCounter, setCorrectAnswerCounter] = useState<number>(0);

    let titleElement = useRef<HTMLInputElement>(null);
